...
class Ex10Py2CWrapper(object):
    ...
    def _insert_into_namespace(self, name, value):
        ...
        TODO: Remove this method as part of PI-28563.
        """
        globals()[name] = value
    ...
    def __getattr__(self, name):
        try:
            ...
            if name == 'get_ex10_protocol':
                ...
                ret_val = GetGenericIntercept(ret_val)
            elif name == 'get_ex10_lbt_helpers':
                ret_val = GetGenericIntercept(ret_val)
...
class GetEx10InterfacesIntercept():
    ...
    def __call__(self, frequency, region):
        ...
        interfaces_intercept.power_modes = ex10_interfaces.power_modes.contents
...
# The TagReadData epc bufer allocation, which includes room for the PC
# This must match the C language symbol EPC_BUFFER_BYTE_LENGTH in ex10_helpers.h
EPC_BUFFER_BYTE_LENGTH = EPC_LENGTH_BYTES + PC_LENGTH_BTES + XPC_LENGTH_BYTES
...
class Ex10CommandsHostResult(IntEnum):
    HostCommandsSuccess = 0
    HostCommandsBadNumSpans = 1
    HostCommandsNullData = 2
    HostCommandsOverMaxDeviceAddress = 3
    HostCommandsRecievedLengthIncorrect = 4
    HostCommandsBadCommandedLength = 5
    HostCommandsTestTransferVerifyError = 6
    HostCommands32BitAlignment = 7
...
class Ex10CommandsHostErrors(Structure):
    _fields_ = [
        ('error_occurred', c_bool),
        ('host_result', c_uint32),
        ('device_response', c_uint32),
    ]
...
class Ex10GpioInterface(Structure):
    _fields_ = [
        ...
        ('register_irq_callback', CFUNCTYPE(c_int, CFUNCTYPE(None))),
        ('deregister_irq_callback', CFUNCTYPE(c_int)),
        ...
        ('busy_wait_ready_n', CFUNCTYPE(c_int, c_uint32)),
...
class Ex10Protocol(Structure):
    _fields_ = [
        ...
        ('get_write_multiple_stored_settings', CFUNCTYPE(None, POINTER(RegisterInfo), c_void_p, c_size_t, POINTER(ByteSpan))),
        ('read_info_page_buffer', CFUNCTYPE(None, c_uint32, POINTER(c_uint8))),
        ('read_multiple', CFUNCTYPE(Ex10CommandsHostErrors, POINTER(RegisterInfo), c_void_p, c_size_t)),
        ...
        ('reset', CFUNCTYPE(c_int, c_uint32)),
        ...
        ('test_transfer', CFUNCTYPE(Ex10CommandsHostErrors, POINTER(ConstByteSpan), POINTER(ByteSpan), c_bool)),
    ]
...
class Ex10Helpers(Structure):
    _fields_ = [
        ('check_board_init_status', CFUNCTYPE(c_int, c_uint32)),
        ('print_op_completion_status', CFUNCTYPE(None, POINTER(OpCompletionStatus))),
        ('print_commands_host_errors', CFUNCTYPE(None, POINTER(Ex10CommandsHostErrors))),
        ...
        ('get_rssi_from_fifo_packet', CFUNCTYPE(c_uint16)),
...
class Ex10LbtHelpers(Structure):
    _fields_ = [
        ('multi_listen_before_talk_rssi', CFUNCTYPE(c_int16, c_uint8, c_uint32, c_int32, c_uint8, c_uint8, c_int32, c_uint32)),
        ('simple_inventory_lbt', CFUNCTYPE(c_uint32, POINTER(InventoryHelperParams), c_uint32, c_int32, c_uint8, c_uint8, c_int32, c_uint32)),
    ]
...
class Ex10Ops(Structure):
    _fields_ = [
        ('init', CFUNCTYPE(None, POINTER(Ex10Protocol))),
        ('init_ex10', CFUNCTYPE(OpCompletionStatus)),
        ...
        ('rf_mode_is_drm', CFUNCTYPE(c_bool, c_uint16)),
        ...
        ('radio_power_control', CFUNCTYPE(None, c_bool)),
        ...
        ('measure_rssi', CFUNCTYPE(None, c_uint8)),
        ('get_default_lbt_rx_analog_configs', CFUNCTYPE(RxGainControlFields)),
        ('run_listen_before_talk', CFUNCTYPE(None, c_uint8, c_uint16, c_int32, c_uint8)),
        ...
        ('set_clear_gpio_pins', CFUNCTYPE(None, POINTER(GpioPinsSetClear))),
        ...
        ('start_hpf_override_test_op', CFUNCTYPE(None, POINTER(HpfOverrideSettingsFields))),
        ('start_etsi_burst', CFUNCTYPE(OpCompletionStatus, POINTER(InventoryRoundControlFields), POINTER(InventoryRoundControl_2Fields), POINTER(GpioPinsSetClear), c_uint16, POINTER(PowerConfigs), POINTER(RfSynthesizerControlFields), POINTER(RegulatoryTimers), c_uint16, c_uint16)),
        ('start_ber_test', CFUNCTYPE(None, c_uint16, c_uint16, c_bool)),
        ('send_select', CFUNCTYPE(None)),
        ('write_calibration_page', CFUNCTYPE(None, POINTER(c_uint8), c_size_t)),
        ('cw_off', CFUNCTYPE(None)),
        ('cw_on', CFUNCTYPE(OpCompletionStatus, POINTER(GpioPinsSetClear), c_uint16, POINTER(PowerConfigs), POINTER(RfSynthesizerControlFields), POINTER(RegulatoryTimers), POINTER(PowerDroopCompensationFields))),
        ('ramp_transmit_power', CFUNCTYPE(OpCompletionStatus, POINTER(PowerConfigs), POINTER(RegulatoryTimers))),
        ('inventory', CFUNCTYPE(OpCompletionStatus, POINTER(GpioPinsSetClear), c_uint16, POINTER(PowerConfigs), POINTER(RfSynthesizerControlFields), POINTER(RegulatoryTimers), POINTER(InventoryRoundControlFields), POINTER(InventoryRoundControl_2Fields), c_bool, POINTER(PowerDroopCompensationFields))),
        ('get_device_time', CFUNCTYPE(c_uint32)),
        ('enable_droop_compensation', CFUNCTYPE(None, POINTER(PowerDroopCompensationFields))),
        ('disable_droop_compensation', CFUNCTYPE(None)),
        ('register_pre_rampup_callback', CFUNCTYPE(None, CFUNCTYPE(c_bool))),
        ('register_post_rampup_callback', CFUNCTYPE(None, CFUNCTYPE(c_bool))),
        ('unregister_pre_rampup_callback', CFUNCTYPE(None)),
        ('unregister_post_rampup_callback', CFUNCTYPE(None)),
        ('op_error_none', POINTER(OpCompletionStatus)),
    ]
...
class Ex10Reader(Structure):
    _fields_ = [
        ...
        ('ber_test', CFUNCTYPE(OpCompletionStatus, c_uint8, c_uint16, c_uint16, c_uint32, c_uint16, c_uint16, c_bool)),
        ...
        ('get_return_loss_threshold_exceeded', CFUNCTYPE(c_bool, c_uint16, c_uint16, c_uint32, c_int16)),
    ]
...
class Ex10PowerModes(Structure):
    _fields_ = [
        ('init', CFUNCTYPE(None)),
        ('deinit', CFUNCTYPE(None)),
        ('set_power_mode', CFUNCTYPE(OpCompletionStatus, c_uint32)),
...
class Ex10EventFifoPrinter(Structure):
    _fields_ = [
        ...
        ('print_tag_read_data', CFUNCTYPE(c_size_t, POINTER(TagReadData))),
    ]
...
class Ex10Region(Structure):
    _fields_ = [
        ...
        ('get_active_channel_index', CFUNCTYPE(c_size_t)),
        ('get_next_channel_index', CFUNCTYPE(c_size_t)),
        ('get_channel_index', CFUNCTYPE(c_int, c_uint32)),
...
class Ex10Interfaces(Structure):
    _fields_ = [
        ...
        ('power_modes', POINTER(Ex10PowerModes)),
...
class Ex10BoardInitStatus(Structure):
    _fields_ = [
        ('power_up_status', c_int),
        ('protocol_error', c_int),
        ('op_status', OpCompletionStatus),
    ]


class Ex10Commands(Structure):
    _fields_ = [
        ('read', CFUNCTYPE(Ex10CommandsHostErrors, POINTER(RegisterInfo), POINTER(ByteSpan), c_size_t, c_uint32)),
        ('test_read', CFUNCTYPE(Ex10CommandsHostErrors, c_uint32, c_uint16, c_void_p)),
        ('extend_write_buffer', CFUNCTYPE(None, c_uint16, c_uint16, POINTER(c_uint8), c_void_p)),
        ('write', CFUNCTYPE(Ex10CommandsHostErrors, POINTER(RegisterInfo), POINTER(ConstByteSpan), c_size_t, c_uint32)),
        ('read_fifo', CFUNCTYPE(Ex10CommandsHostErrors, c_uint32, POINTER(ByteSpan))),
        ('write_info_page', CFUNCTYPE(Ex10CommandsHostErrors, c_uint8, POINTER(ConstByteSpan), c_uint16)),
        ('start_upload', CFUNCTYPE(Ex10CommandsHostErrors, c_uint8, POINTER(ConstByteSpan))),
        ('continue_upload', CFUNCTYPE(Ex10CommandsHostErrors, POINTER(ConstByteSpan))),
...
class Ex10BoardSpec(Structure):
    _fields_ = [
        ...
        ('get_gpio_output_levels', CFUNCTYPE(c_uint32, c_uint8, c_uint32, c_uint32)),
        ('get_gpio_output_enables', CFUNCTYPE(c_uint32)),
        ('get_gpio_output_pins_set_clear', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint8, c_uint16, c_uint32, c_uint32)),
...
class Ex10GpioHelpers(Structure):
    _fields_ = [
        ...
        ('set_antenna_port', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint8)),
        ('set_rx_baseband_filter', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint32)),
        ('set_pa_bias_enable', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_bool)),
        ('set_pa_power_range', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint32)),
        ('set_rf_power_supply_enable', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_bool)),
        ('set_tx_rf_filter', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint32)),
        ('set_dio_unused_pins', CFUNCTYPE(None, POINTER(GpioPinsSetClear), c_uint32)),
        ('print_pin_bits', CFUNCTYPE(None, POINTER(None), c_uint32)),
    ]
