...
7. If the py3_venv is already set up, you can enter the virtual environment by typing:
...
9. The inventory example will run for 60 seconds, reading tags and printing their EPCs to the console.
