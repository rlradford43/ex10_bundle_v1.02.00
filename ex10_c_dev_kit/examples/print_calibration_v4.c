...
#include "board/e710_ref_design/calibration_v4.h"
...
static void print_calibration(struct Ex10CalibrationParamsV4 const* calibration)
{
    printf("Calibration:\n");
    printf(
...
int main(void)
{
    ...
    if (result == 0)
    {
        ...
        if (cal_version == 4)
        {
            get_ex10_cal_v4()->init(ex10_iface.protocol);

            struct Ex10CalibrationParamsV4 const* calibration =
